...
const employeeinfo = users.map((user) => user.displayName,user.employeeNumber,user.jobtitle);
console.log(employeeinfo)

const seniorengineer = users.filter((user)=> user.jobtitle === 'Sr. Front-End Engineer')
console.log(seniorengineer)

const employeenumber = users.reduce 
((accmulator,currentValue)=> accmulator + currentValue.employeeNumber,0)
